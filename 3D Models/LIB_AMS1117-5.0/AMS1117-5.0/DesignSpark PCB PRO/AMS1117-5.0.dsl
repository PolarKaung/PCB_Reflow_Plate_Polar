SamacSys ECAD Model
1075451/937371/2.49/4/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AMS1117-5_0" (originalName "AMS1117-5_0")
		...
		(pin (pinNum 4) (pt 1500 mils -100 mils) (rotation 180) (pinLength 200 mils) (pinDisplay (dispPinName false)) (pinName (text (pt 1270 mils -125 mils) (rotation 0]) (justify "Right") (textStyleRef "Default"))
		))
	...
	(compDef "AMS1117-5.0" (originalName "AMS1117-5.0") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "GROUND/ADJUST") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AMS1117-5_0"))
		...
		(attr "Manufacturer_Part_Number" "AMS1117-5.0")
		...
		(attr "Description" "1A LOW DROPOUT VOLTAGE REGULATOR")
