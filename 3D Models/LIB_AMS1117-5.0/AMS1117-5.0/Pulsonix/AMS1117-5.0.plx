...
(library Library_1
	...
	(symbolDef "AMS1117-5.0" (originalName "AMS1117-5.0")
	...
	(compDef "AMS1117-5.0" (originalName "AMS1117-5.0") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "GROUND/ADJUST") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AMS1117-5.0"))
		...
		(attr "<STEP Filename>" "AMS1117-5.0.stp")
