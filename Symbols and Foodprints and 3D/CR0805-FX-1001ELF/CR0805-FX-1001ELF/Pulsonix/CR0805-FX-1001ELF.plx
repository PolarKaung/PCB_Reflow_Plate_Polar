...
//231047/937371/2.49/2/3/Resistor
...
(library Library_1
	...
	(symbolDef "CR0805-FX-1001ELF" (originalName "CR0805-FX-1001ELF")
	...
	(compDef "CR0805-FX-1001ELF" (originalName "CR0805-FX-1001ELF") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CR0805-FX-1001ELF"))
		...
		(attr "Manufacturer_Part_Number" "CR0805-FX-1001ELF")
		(attr "Mouser Part Number" "652-CR0805FX-1001ELF")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Bourns/CR0805-FX-1001ELF?qs=tknLyCMIRbOJasvgRv5Bdg%3D%3D")
		(attr "Arrow Part Number" "CR0805-FX-1001ELF")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/cr0805-fx-1001elf/bourns?region=nac")
		(attr "Mouser Testing Part Number" "")
		(attr "Mouser Testing Price/Stock" "")
		(attr "Description" "SMD 0805 thick film resistor 1K 1% Bourns CR0805-FX Series Thick Film Surface Mount Fixed Resistor 0805 Case 1k +/-1% 0.125W +/-100ppm/C")
		(attr "<Hyperlink>" "https://www.bourns.com/pdfs/chpreztr.pdf")
		(attr "<Component Height>" "0.6")
		(attr "<STEP Filename>" "CR0805-FX-1001ELF.stp")
