...
(library Library_1
	...
	(symbolDef "PESD18VF1BLYL" (originalName "PESD18VF1BLYL")
		...
		(pin (pinNum 2) (pt 800 mils 0 mils) (rotation 180) (pinLength 100 mils) (pinDisplay (dispPinName false)) (pinName (text (pt 660 mils -15 mils) (rotation 0]) (justify "Right") (textStyleRef "Default"))
		))
		...
		(attr "RefDes" "RefDes" (pt 450 mils 350 mils) (justify Center) (isVisible True) (textStyleRef "Default"))
	...
	(compDef "PESD18VF1BLYL" (originalName "PESD18VF1BLYL") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		...
		(attr "Datasheet Link" "https://assets.nexperia.com/documents/data-sheet/PESD18VF1BL.pdf")
		(attr "Height" "0 mm")
	)
