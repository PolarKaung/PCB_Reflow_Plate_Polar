...
(library Library_1
	...
	(patternDef "LMT85LP" (originalName "LMT85LP")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 1.270, 0.541) (textStyleRef "Default") (isVisible True))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt 3.683 0) (pt 3.683 -1.33) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.683 -1.33) (pt -1.143 -1.33) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.143 -1.33) (pt -1.143 -1.33) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.143 -1.33) (pt -1.143 0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "LMT85LP" (originalName "LMT85LP") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		...
		(attr "Datasheet Link" "https://www.ti.com/lit/ds/symlink/lmt85.pdf?HQS=dis-mous-null-mousermode-dsf-pf-null-wwe&ts=1635242341074&ref_url=https%253A%252F%252Fwww.mouser.de%252F")
		(attr "Height" "5.34 mm")
	)
